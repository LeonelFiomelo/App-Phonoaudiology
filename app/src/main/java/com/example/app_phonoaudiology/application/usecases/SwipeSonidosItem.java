...
public class SwipeSonidosItem {
    ...
    public SwipeSonidosItem(Activity activity, RecyclerView recyclerView, SonidosAdapter sonidosAdapter, List<SoundEntity> lista) {
...
//                                soundRepository.eliminarSonido(lista.get(viewHolder.getAbsoluteAdapterPosition()));
